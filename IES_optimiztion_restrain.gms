...
**************************************************CHP机组参数
       ...
       Pmax_chp       Maximum Active Power of CHP /8000/
...
************************************************** 燃气机组、燃气锅炉、电热炉、电制冷机参数
       Pmax_gt        Maximum Active Power of Gas Turbine /8000/
       ...
       Cmax_pc        Maximum Cold Power of Electric Cooler /6000/
...
**************************************************储能装置数据
       ...
       CSmin_cs       Mmi nimum Storing Cold of CSU /0/
...
*********************静态可转换性指标
        ...
        Equ_Afa_st_C       ..afa_st_C=e=(Cmax_chp+Cmax_pc)/11000;
        Equ_Afa_st_H       ..afa_st_H=e=(Hmax_chp+Hmax_gb+Hmax_ph)/8000;
        Equ_Afa_st_P       ..afa_st_P=e=(Pmax_chp+Pmax_gt)/15000;
        Equ_Afa_st         ..afa_st=e=(Cmax_chp+Cmax_pc+Hmax_chp+Hmax_gb+Hmax_ph+Pmax_chp+Pmax_gt)/44000;
...
*********************动态可转换性指标
        Equ_Afa_dy_C(T)    ..Afa_dy_C(T)=e=afa_st_C-(C_chp(T)+C_pc(T))/11000;
        Equ_Afa_dy_H(T)    ..Afa_dy_H(T)=e=afa_st_H-(H_chp(T)+H_gb(T)+H_ph(T))/8000;
        Equ_Afa_dy_P(T)    ..Afa_dy_P(T)=e=afa_st_P-(P_chp(T)+P_gt(T))/15000;
...
*********************动态可转换指标约束
        Rest_Afa_dy_C(T)       ..Afa_dy_C(T)=g=0.1*afa_st_C;
        Rest_Afa_dy_H(T)       ..Afa_dy_H(T)=g=0.1*afa_st_H;
        Rest_Afa_dy_P(T)       ..Afa_dy_P(T)=g=0.1*afa_st_P;
